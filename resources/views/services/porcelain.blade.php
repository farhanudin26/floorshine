...
@section('meta_description', 'Professional porcelain tiles polishing in Singapore. We restore the lustre & beauty of
    your porcelain floors. Free quote available — call +65 8811 2999.')

@section('meta_keywords', 'porcelain tiles polishing singapore, porcelain floor polishing service singapore, porcelain
    floor restoration, porcelain polishing hdb, porcelain polishing condo singapore')

@section('og_title', 'Porcelain Tiles Polishing Services Singapore | Floorshine')
@section('og_description', 'Professional porcelain tiles polishing services in Singapore. Restoring the lustre and
    beauty of your porcelain floors. Trusted by 800+ customers. Get a free quote today!')
    ...
    "@graph": [
        {
            ...
            "image": "{{ asset('images/porcelain-page/porcelain.webp') }}",
...
@endsection
@push('preload')
    <link rel="preload" as="image" href="{{ asset('images/porcelain-page/porcelain.webp') }}" fetchpriority="high">
@endpush
@push('styles')
    <style>
        .porcelain-hero {
...
@section('content')
    ...
    <section class="porcelain-hero">
        ...
        <img src="{{ asset('images/porcelain-page/porcelain.webp') }}" alt="Porcelain Tiles Polishing Singapore"
            fetchpriority="high" loading="eager" decoding="async" width="1920" height="800" class="porcelain-hero__bg">

        <div class="container" style="position: relative; z-index: 1;">
            <div class="hero-badge">Professional Floor Polishing — Singapore</div>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="img-panel">
                    ...
                    <div class="img-box"><img src="{{ asset('images/porcelain-page/porcelain-room.webp') }}"
    ...
    <section class="gray-bg">
        <div class="container">
            <div class="why-grid">
                ...
                <div class="why-img"> <img src="{{ asset('images/porcelain-page/porcelain-why.webp') }}"
        ...
        <div class="container">
            ...
            <div class="process-intro-grid">
                <div class="process-img-box">
                    <img src="{{ asset('images/porcelain-page/porcelain-process.webp') }}" alt="Porcelain Process"
            ...
            <div class="maint-block">
                <div class="maint-grid">
                    ...
                    <div class="maint-img-box">
                        <img src="{{ asset('images/porcelain-page/porcelain-maintenance.webp') }}"
