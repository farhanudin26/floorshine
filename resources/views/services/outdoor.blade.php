...
@section('meta_description',
    'Professional outdoor ceramic tiles polishing in Singapore. We restore the lustre & beauty
    of your outdoor tiles. Free quote available — call +65 8811 2999.')

@section('meta_keywords',
    'outdoor ceramic tiles polishing singapore, outdoor floor polishing singapore, outdoor ceramic
    polishing service, outdoor tiles restoration singapore, outdoor floor polishing hdb')

@section('og_title', 'Outdoor Ceramic Tiles Polishing Singapore | Floorshine')
@section('og_description',
    'Professional outdoor ceramic tiles polishing services in Singapore. Restoring the lustre and
    beauty of your outdoor ceramic tiles. Trusted by 800+ customers. Get a free quote today!')
    ...
    "@graph": [
        {
            ...
            "image": "{{ asset('images/outdoor-page/outdoor.webp') }}",
...
@endsection
@push('preload')
    <link rel="preload" as="image" href="{{ asset('images/outdoor-page/outdoor.webp') }}" fetchpriority="high">
@endpush
@push('styles')
    <style>
        .outdoor-hero {
...
@section('content')
    ...
    <section class="outdoor-hero">
        ...
        <img src="{{ asset('images/outdoor-page/outdoor.webp') }}" alt="Outdoor Ceramic Tiles Polishing Singapore"
            fetchpriority="high" loading="eager" decoding="async" width="1920" height="800" class="outdoor-hero__bg">
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="img-panel">
                    ...
                    <div class="img-box">
                        <img src="{{ asset('images/outdoor-page/outdoor-room.webp') }}" alt="Outdoor Ceramic Tiles"
    ...
    <section class="gray-bg">
        <div class="container">
            <div class="why-grid">
                ...
                <div class="why-img">
                    <img src="{{ asset('images/outdoor-page/outdoor-why.webp') }}" alt="outdoor Why Polish"
        ...
        <div class="container">
            ...
            <div class="process-intro-grid">
                <div class="process-img-box">
                    <img src="{{ asset('images/outdoor-page/outdoor-process.webp') }}" alt="outdoor Process"
                        style="width:100%;height:100%;object-fit:cover;">
                </div>
            ...
            <div class="maint-block">
                <div class="maint-grid">
                    ...
                    <div class="maint-img-box">
                        <img src="{{ asset('images/outdoor-page/outdoor-maintenance.webp') }}" alt="Outdoor Maintenance">
                    </div>
                </div>
            </div>
